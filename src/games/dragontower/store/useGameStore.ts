...
export const useGameStore = create<GameStore>()((set) => ({
  ...
  diff: (_savedSettings.diff as Difficulty) ?? "Medium",
  gstate: "idle",
  rgstate: "newgame",
  curRow: 0,
  curMult: 1,
  ...
  auto: {
    ...
    autoDiff: (_savedSettings.autoDiff as Difficulty) ?? "Medium",
    autoCashoutRow: 0,
  },
  autoRunning: false,
  ...
  setDiff: (v) => { set({ diff: v }); saveSettings({ diff: v }); },
